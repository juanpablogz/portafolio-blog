<template>
  <div class="container-projects" style="display: block; max-width: 800px;">
    <h2>Sobre mi</h2>
    <p>Hola mi nombre es juan pablo, soy desarrollador de software, vivo en medellin,colombia.Desarrollo aplicaciones web, principalmente con Vuejs, Quasar y NuxtJs. En el backend he realizado Api rest con ruby on rails</p>
    <h2>Experiencia laboral</h2>
    <div>Experiencia <strong>junio de 2018 - presente (emprendimiento propio)</strong></div>
